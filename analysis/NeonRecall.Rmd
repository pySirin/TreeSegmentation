...
#set data paths
path_to_tiles=paste("../data/NeonTreeEvaluation/",site,"/",sep="")
basemap=paste("../data/NeonTreeEvaluation/",site,"/",sep="")
...
rgb_tiles<-list.files(paste("/Users/Ben/Documents/DeepLidar/data/",site,sep=""))
