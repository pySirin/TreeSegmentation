...
site<-c("ARIK","BARR","BART","BONA","CLBJ","CPER","CUPE","DEJU","DELA","DSNY","GRSM","GUAN",
...
foreach(x=1:length(site),.packages=c("neonUtilities","TreeSegmentation","dplyr"),.errorhandling = "pass") %dopar% {
  ...
  byPointsAOP(dpID="DP1.30010.001",site=site[x],year="2018",check.size=F, savepath=fold,allSites=F)
