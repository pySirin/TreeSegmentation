...
```{r,eval=T}
system.time(results_all<-evaluate_all(itcs=itcs,algorithm = c("silva"),path_to_tiles=path_to_tiles,cores=1,extra=F,plot_results = T,basemap="../data/2017/Camera/L1/"))
