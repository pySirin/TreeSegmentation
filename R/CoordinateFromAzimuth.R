#' Extract geographic coordinates from plot center measurements
#'
#' \code{CoordinateFromAzimuth} returns a canopy height raster from a lidR point cloud
#'
#'
#' @param dista
#' @param angle
...
#' @return
#' @export
CoordinateFromAzimuth<-function(dista, angle, xcord, ycord){
      if(angle <= 90){
